...
Modules in Phizy-Stack are plug-and-play features you can add to any project with a single command. Each module is prebuilt, fully integrated, and follows best practices—so you can move fast without wiring things up manually.
...
<Cards>
  <Card
    ...
    href="https://github.com/your-org/phizy-stack"
  />
